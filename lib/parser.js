...
var parseArmingStatusData = function(msgData) {
  ...
  for(var i=0; i<=7; i++) {
    ...
    switch(parseInt(armUpStates[i])) {
      case 0:
        msgData['area' + (i+1)].armUpState = 'Not Ready to Arm';
        break;
      case 1: 
        msgData['area' + (i+1)].armUpState = 'Ready to Arm';
        break;
      case 2: 
        msgData['area' + (i+1)].armUpState = 'Ready to Arm, but a zone is violated and can be force armed';
        break;
      case 3:
        msgData['area' + (i+1)].armUpState = 'Armed with Exit Timer working';
        break;
      case 4:
        msgData['area' + (i+1)].armUpState = 'Armed Fully';
        break;
      case 5:
        msgData['area' + (i+1)].armUpState = 'Force Armed with a force arm zone violated';
        break;
      case 6:
        msgData['area' + (i+1)].armUpState = 'Armed with a Bypass';
        break;
    }
    
    switch(alarmStates[i]) {
      case '0':
        msgData['area' + (i+1)].alarmState = 'No Alarm Active';
        break;
      case '1': 
        msgData['area' + (i+1)].alarmState = 'Entrance Delay is Active';
        break;
      case '2': 
        msgData['area' + (i+1)].alarmState = 'Alarm Abort Delay Active';
        break;
      case '3':
        msgData['area' + (i+1)].alarmState = 'Fire Alarm';
        break;
      case '4':
        msgData['area' + (i+1)].alarmState = 'Medical Alarm';
        break;
      case '5':
        msgData['area' + (i+1)].alarmState = 'Police Alarm';
        break;
      case '6':
        msgData['area' + (i+1)].alarmState = 'Burglar Alarm';
        break;  
      case '7':
        msgData['area' + (i+1)].alarmState = 'Aux1 Alarm';
        break;
      case '8':
        msgData['area' + (i+1)].alarmState = 'Aux2 Alarm';
        break;  
      case '9':
        msgData['area' + (i+1)].alarmState = 'Aux3 Alarm';
        break;  
      case ':': 
        msgData['area' + (i+1)].alarmState = 'Aux4 Alarm';
        break;
      case ';': 
        msgData['area' + (i+1)].alarmState = 'Carbon Monoxide Alarm';
        break;
      case '<':
        msgData['area' + (i+1)].alarmState = 'Emergency Alarm';
        break;
      case '=':
        msgData['area' + (i+1)].alarmState = 'Freeze Alarm';
        break;
      case '>':
        msgData['area' + (i+1)].alarmState = 'Gas Alarm';
        break;
      case '?':
        msgData['area' + (i+1)].alarmState = 'Heat Alarm';
        break;  
      case '@':
        msgData['area' + (i+1)].alarmState = 'Water Alarm';
        break;
      case 'A':
        msgData['area' + (i+1)].alarmState = 'Fire Supervisory';
        break;  
      case 'B':
        msgData['area' + (i+1)].alarmState = 'Verify Fire';
        break;
