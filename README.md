...
The Elk M1 has a large library of words that it can say over it's speaker. With the **elknode** `speak()` function, you can make your Elk say all kinds of wacky (or useful) stuff...
